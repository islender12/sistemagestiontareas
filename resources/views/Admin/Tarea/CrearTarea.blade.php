            ...
            <form action="{{ route('tareas.store') }}" method="POST">
                ...
                <div class="mt-4 grid gap-4 lg:grid-cols-2">
                    <div class="text-center sm:text-left order-1">
                        <label for="nombre" class="block mb-3 font-medium">Nombre de la Tarea</label>
                        <input type="text" name="nombre" id="nombre"
                            ...
                            placeholder="Nombre de la tarea" value="{{ old('nombre') }}">
                    </div>
                    ...
                    <div class="text-center sm:text-left order-3 lg:order-2">
                        <div class="mb-4">
                            <label for="proyecto_id" class="block mb-3 font-medium">Asignar Tarea al Proyecto</label>
